 ...
 */
//export function map<T>(mapper: (item: T) => T, input: T[]): T[] ;
export function map<T, T1>(
    mapper?: (item: T ) => T1,
    input?: T[]
): typeof map | T1[] | ((input: T[]) => T1[])
...
export function reduce<T, T1>(
    reducer?: (prevItem: T1, currItem: T, currIndex: number, array: T[]) => T1,
    initialValue?: T1,
    input?: T[]
): T1 | typeof reduce | ((input: T[])=> T1[]) | ((initialValue: T1) => (input: T[]) => T1) ;
...
export function subtract(
    a?: number ,
    b?: number
): typeof subtract | ((b: number) => number) | number;
...
export function prop(
    obj?: object,
    propName?: string
): string | ((propName: string)=> string) | typeof prop;
...
export function pipe(
    functions?: Function[]
): typeof pipe | (functions : Function[] () => Function[]) ; // :(((((((
